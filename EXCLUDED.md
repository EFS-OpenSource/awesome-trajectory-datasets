...
|---------|------|----------|--------|
| **[CitySim](https://github.com/UCF-SST-Lab/UCF-SST-CitySim1-Dataset)** | 2023 | USA | Data requested, but no feedback |
| **[Harypdata](https://www.kios.ucy.ac.cy/harpydata/tlsdataset/)** | — | — | Download dataset -> 404 Error |
| **[INTERACTION](https://interaction-dataset.com/)** | 2019 | Multi-country | Data requested, but no feedback |
...
- Open an issue or pull request on [awesome-trajectory-datasets](https://github.com/yourusername/awesome-trajectory-datasets).
